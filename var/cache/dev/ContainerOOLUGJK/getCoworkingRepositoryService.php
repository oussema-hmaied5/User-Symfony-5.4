 ...
 */
class getCoworkingRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CoworkingRepository' shared autowired service.
     *
     * @return \App\Repository\CoworkingRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CoworkingRepository.php';

        return $container->privates['App\\Repository\\CoworkingRepository'] = new \App\Repository\CoworkingRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
