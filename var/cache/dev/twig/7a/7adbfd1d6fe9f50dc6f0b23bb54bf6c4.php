...
class __TwigTemplate_2cc835844f74dfd7068822038a5b3c82 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        // line 1
        echo "<p>Bonjour ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 1, $this->source); })()), "nom", [], "any", false, false, false, 1), "html", null, true);
        echo " ";
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 1, $this->source); })()), "prenom", [], "any", false, false, false, 1), "html", null, true);
        echo "</p>
...
<p>Merci</p>";
    ...
    {
        return new Source("<p>Bonjour {{ user.nom}} {{ user.prenom }}</p>
<p>Pour votre demande de réinitialisation de mot de passe, veuillez cliquer sur le lien suivant : <a href=\"{{ url|raw }}\">{{ url|raw }}</a></p>
<p>Merci</p>", "emails/password_reset.html.twig", "C:\\Users\\oussa\\Desktop\\colocstudy-coworking\\templates\\emails\\password_reset.html.twig");
    }
}
