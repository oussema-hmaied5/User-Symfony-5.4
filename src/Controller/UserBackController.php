...
class UserBackController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager, UserPasswordHasherInterface $userPasswordHasher): Response
    {
        ...
        return $this->renderForm('admin_back/user/new.html.twig', [
            'user' => $user,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('admin_back/user/show.html.twig', [
            'user' => $user,
        ]);
    }
    ...
    public function edit(Request $request, User $user, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('admin_back/user/edit.html.twig', [
            'user' => $user,
            'form' => $form,
        ]);
    }
